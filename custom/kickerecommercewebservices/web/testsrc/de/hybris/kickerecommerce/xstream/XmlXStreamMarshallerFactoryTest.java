 ...
 */
package de.hybris.kickerecommerce.xstream;
...
{
	private XmlXStreamMarshallerFactory factory;
	...
	private static final String SERVICE_BEAN_DEF = ""// NOPMD
			...
			+ "       <bean\n"//
			+ "             id=\"onlyOneInstance\"\n"//
			+ "             class=\"de.hybris.kickerecommerce.xstream.XmlXStreamMarshallerFactory\">\n"//
			+ "       </bean>\n"//
			+ "</beans>";
	...
	{
		factory = new XmlXStreamMarshallerFactory();
	...
	public void testCreateConverters() throws Exception
	{
		...
		final ThrowableConverter thConverter = new ThrowableConverter(null);
