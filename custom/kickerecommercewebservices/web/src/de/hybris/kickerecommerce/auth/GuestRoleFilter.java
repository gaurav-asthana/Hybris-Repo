 ...
 * 
 */
package de.hybris.kickerecommerce.auth;
...
public class GuestRoleFilter extends OncePerRequestFilter
{
	...
	private void processAuthentication(final String uid)
	{
	...
	private Authentication createGuestAuthentication(final String uid)
	{
		...
		final Authentication authentication = new GuestAuthenticationToken(uid, grantedAuthorities);
		return authentication;
	}

	private boolean isGuest(final CustomerModel cm)
	{
