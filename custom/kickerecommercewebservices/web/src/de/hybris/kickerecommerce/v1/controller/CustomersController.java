...
import de.hybris.kickerecommerce.conv.HttpRequestPaymentInfoPopulator;
import de.hybris.kickerecommerce.populator.HttpRequestAddressDataPopulator;
import de.hybris.kickerecommerce.populator.HttpRequestCustomerDataPopulator;
import de.hybris.kickerecommerce.populator.options.PaymentInfoOption;
import de.hybris.kickerecommerce.user.data.AddressDataList;
import de.hybris.kickerecommerce.user.data.LoginChangeResponse;
import de.hybris.kickerecommerce.user.data.PasswordRestoreResponse;
...
public class CustomersController extends BaseController
{
			...
			throws DuplicateUidException, SessionAttributeException
	{
		...
		if (LOG.isDebugEnabled())
		{
			LOG.debug("convert user: order guid=" + orderGuid);
		}
	...
	public void updateDefaultAddress(@PathVariable final String id) throws DuplicateUidException
	{
		...
		if (address == null)
		{
			throw new RequestParameterException("Address with given id: '" + id + "' doesn't exist or belong to another user",
			...
			throws RequestParameterException
	{
		...
		{
			throw new RequestParameterException("Payment info [" + paymentInfoId + "] not found.",
